                ...
                <div class="px-2 py-4 rounded-xl bg-gray-200 shadow-xl w-1/2 mx-auto mt-8">
                    <form action="nuevo.php" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea rows='5' name="descripcion" id="desc" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"></textarea>
                            <?php
                        ...
                        <div class="mb-4">
                            ...
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="precio" type="number" placeholder="Precio" name="precio" step="0.01" min='0.00' max='9999.99'>
                            <?php
                        ...
                        <div class="mb-4">
                            ...
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="stock" type="number" placeholder="Stock" name="stock" min='0'>
                            <?php
